...
// TestGC_RefTestAndCast exercises ref.test / ref.cast against:
//   - abstract heap types (i31, struct, array, any)
//   - concrete struct and array type indices
//   - null references (with and without the `null` cast variant)
//
// Covers the discrimination strategy described in RATIONALE.md: tagged
// i31 via PackI31, heap-pointed structs/arrays via TypeID read + Form
// lookup, and concrete-type subtyping via Store.IsSubtype.
...
// TestGC_BrOnNullAndNonNull exercises br_on_null and br_on_non_null.
//
// br_on_null  l: pop ref; if null, branch to l; else push back and fall through
// br_on_non_null l: pop ref; if non-null, push back and branch to l; else fall through
...
// TestGC_CallRef exercises call_ref end-to-end: take a funcref, type-
// check it against the expected type, and call.
