...
// the field's declared storage type. The conversion mirrors
// decodeFieldValueRead in reverse.
...
// for packed fields based on the read variant (operationKindStructGetS /
// operationKindStructGetU / operationKindStructGet).
